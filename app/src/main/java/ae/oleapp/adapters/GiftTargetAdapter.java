...
public class GiftTargetAdapter extends RecyclerView.Adapter<GiftTargetAdapter.ViewHolder> {
    ...
    private final List<GiftTargetList> list;
    private ItemClickListener itemClickListener;
    private String selectedId = "";
    private int selectedIndex;

    public GiftTargetAdapter(Context context, List<GiftTargetList> list ) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.gift_target_vu, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //GiftTargetList giftList = list.get(position);
