...
public class MakeCaptainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void turnOneOneClicked() {
        ...
        binding.turn12Text.setTextColor(ContextCompat.getColor(getContext(), R.color.blackColor));
    ...
    private void turnOnetwoClicked() {
        ...
        binding.turn11Text.setTextColor(ContextCompat.getColor(getContext(), R.color.blackColor));
