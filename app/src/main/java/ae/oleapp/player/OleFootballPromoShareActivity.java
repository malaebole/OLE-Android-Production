...
import ae.oleapp.databinding.OleactivityPromoShareBinding;
import ae.oleapp.models.OlePromoCode;

public class OleFootballPromoShareActivity extends BaseActivity implements View.OnClickListener {

    private OleactivityPromoShareBinding binding;
    ...
    private void populateData() {
        ...
        double oneHourPrice = Double.parseDouble(olePromoCode.getOneHourPrice());
        ...
        if (olePromoCode.getDiscountType().equalsIgnoreCase("amount")) {
            double oneHourD = Double.parseDouble(olePromoCode.getOneHourDiscount());
            ...
            binding.tvOneHour.setText(String.format(Locale.ENGLISH, "%.0f %s", oneHourPrice - oneHourD, olePromoCode.getCurrency()));
            ...
            binding.tvOneHour.setText(String.format(Locale.ENGLISH, "%.0f %s", oneHourPrice - ((discount / 100) * oneHourPrice), olePromoCode.getCurrency()));
